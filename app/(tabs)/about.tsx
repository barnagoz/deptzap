...
export default function About () {
    return (
        ...
        >
            ...
            <Text style={{fontSize: 20, fontWeight: "400", backgroundColor: "#0077b6", padding: 20, width:"100%", borderRadius: 15, color: "white", overflow: 'hidden'}}><Text style={{fontWeight: "bold"}}>Tip:</Text> If you press one of the items in the transaction history, you can share a reminder with your friend.</Text>

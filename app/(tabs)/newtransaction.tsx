...
export default function Adddebt() {
  ...
  return (
    ...
    >
      <Text
        style={{ fontSize: 30, fontWeight: "bold", alignSelf: "flex-start" }}
      >
        New transaction
      </Text>
      <Text style={{ fontSize: 22.5, alignSelf: "flex-start" }}>
        Who owes who?
      </Text>
      <View
        style={{
      ...
      >
        {isEnabled ? "Who do you owe?" : "Who owes you?"}
      </Text>
      <View
        style={{
          flex: 1,
      ...
      >
        {isEnabled ? "How much do you owe?" : "How much do they owe you?"}
      </Text>
      <View
        style={{
          flex: 1,
      ...
      >
        {isEnabled ? "Why do you owe them?" : "Why do they owe you?"}
      </Text>
      <View
        style={{
          flex: 1,
